...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {##I2C 0#I2C 0###UART 0#UART 0######SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#######################################################} \
   CONFIG.PSU_MIO_TREE_SIGNALS {##scl_out#sda_out###rxd#txd######sdio0_data_out[0]#sdio0_data_out[1]#sdio0_data_out[2]#sdio0_data_out[3]#sdio0_data_out[4]#sdio0_data_out[5]#sdio0_data_out[6]#sdio0_data_out[7]#sdio0_cmd_out#sdio0_clk_out#######################################################} \
  ...
  connect_bd_intf_net -intf_net axi_apb_bridge_0_APB_M [get_bd_intf_pins axi_apb_bridge_0/APB_M] [get_bd_intf_pins nvdla_0/S_APB]
  ...
  connect_bd_intf_net -intf_net nvdla_0_m00_axi [get_bd_intf_pins nvdla_0/m00_axi] [get_bd_intf_pins smartconnect_0/S00_AXI]
  ...
  connect_bd_intf_net -intf_net vcu_axi_lite_0_M00_AXI [get_bd_intf_pins axi_apb_bridge_0/AXI4_LITE] [get_bd_intf_pins vcu_axi_lite_0/M00_AXI]

  # Create port connections
  connect_bd_net -net axi_lite_reset_10 [get_bd_pins proc_sys_reset_vcu_0/interconnect_aresetn] [get_bd_pins vcu_axi_lite_0/ARESETN] [get_bd_pins vcu_axi_lite_0/M00_ARESETN] [get_bd_pins vcu_axi_lite_0/S00_ARESETN]
  connect_bd_net -net nvdla_0_dla_intr [get_bd_pins nvdla_0/dla_intr] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net pl_reset_axi [get_bd_pins proc_sys_reset_vcu_0/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
  connect_bd_net -net proc_sys_reset_vcu_0_peripheral_aresetn [get_bd_pins axi_apb_bridge_0/s_axi_aresetn] [get_bd_pins nvdla_0/m00_axi_aresetn] [get_bd_pins proc_sys_reset_vcu_0/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_apb_bridge_0/s_axi_aclk] [get_bd_pins nvdla_0/m00_axi_aclk] [get_bd_pins proc_sys_reset_vcu_0/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins vcu_axi_lite_0/ACLK] [get_bd_pins vcu_axi_lite_0/M00_ACLK] [get_bd_pins vcu_axi_lite_0/S00_ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]

  # Create address segments
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces nvdla_0/m00_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces nvdla_0/m00_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  create_bd_addr_seg -range 0x00010000 -offset 0x80000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs nvdla_0/S_APB/Reg] SEG_nvdla_0_Reg
